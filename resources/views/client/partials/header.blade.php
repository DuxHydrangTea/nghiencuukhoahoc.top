<header class="navbar bg-white/90 backdrop-blur-sm border-b-2 border-gray-100 sticky top-0 z-50">
    <div class="navbar-start">
        <div class="flex items-center space-x-3">
            <div
                class="w-12 h-12 bg-gradient-to-br from-yellow-400 to-orange-400 rounded-full flex items-center justify-center animate-bounce-gentle">
    ...
    <div class="navbar-end">
        <div class="dropdown">
            <div tabindex="0" role="button" class="btn m-1 btn-secondary text-lg font-medium hover-bounce">
                ...
                {{ auth('members')->user()->fullname ?? 'Đăng nhập' }}
            </div>
            <ul tabindex="0"
                class="dropdown-content menu border-2 border-gray-300 bg-base-100 rounded-box z-1 w-52 p-2 shadow-sm">
